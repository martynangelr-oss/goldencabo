...
// ── Admin Panel
Route::prefix('admin')->name('admin.')->middleware(['auth', 'session.timeout'])->group(function () {
    Route::get('/',                              [AdminController::class, 'dashboard'])->name('dashboard');

    Route::middleware('cms.permission:bookings')->group(function () {
    ...
    Route::middleware('cms.permission:contacts')->group(function () {
    ...
    Route::prefix('cms')->name('cms.')->group(function () {
        // Vehicles
        Route::middleware('cms.permission:vehicles')->group(function () {
        ...
        // Tours
        Route::middleware('cms.permission:tours')->group(function () {
        ...
        // Zones & Hotels
        Route::middleware('cms.permission:zones')->group(function () {
        ...
        // Carousel
        Route::middleware('cms.permission:carousel')->group(function () {
        ...
        // Gallery
        Route::middleware('cms.permission:gallery')->group(function () {
        ...
        // Section Images
        Route::middleware('cms.permission:sections')->group(function () {
        ...
        // Settings
        Route::middleware('cms.permission:settings')->group(function () {
