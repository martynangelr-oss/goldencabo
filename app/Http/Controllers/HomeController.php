...
class HomeController extends Controller
{
    public function __construct(
        ...
        private SectionImageService $sectionImages,
    ...
    {
        try {
            $zonesCollection = $this->zones->activeForHome();
            ...
            $vehiclesCollection = $this->vehicles->availableForHome();
            ...
            $toursCollection = $this->tours->activeForHome();
            $tours = $toursCollection->isNotEmpty()
                ? $toursCollection->map(fn ($t) => [
                    ...
                    'description_en' => $t->route_description_en ?? $t->route_description ?? '',
                    'tags' => $t->destinations ?? [],
                    'tags_en' => $t->destinations_en ?? $t->destinations ?? [],
                ])->toArray()
                : self::getTours();

            // Carousel slides
            $slidesCollection = $this->carousel->activeForHome();
            ...
            // Gallery images
            $galleryCollection = $this->gallery->activeForHome();
        ...
        $sectionImages = [
            'about_main' => $this->sectionImages->urlFor('about_img_main'),
            'about_secondary' => $this->sectionImages->urlFor('about_img_secondary'),
            'airport_main' => $this->sectionImages->urlFor('airport_img_main'),
        ];

        // Global settings
        $siteSettings = $this->settings->homepageSettings();
    ...
    {
        return [
            ['name' => 'Recorrido a La Paz', 'name_en' => 'La Paz Tour', 'duration' => '10 horas', 'price' => '$420 USD', 'price_suffix' => '',
                ...
                'description_en' => 'Private transport visiting the Tropic of Cancer, Buena Vista, Los Barriles, San Antonio, El Triunfo and La Paz. Includes Balandra Beach, the Malecón, a pearl demonstration and free time.',
                'tags' => ['Playa Balandra', 'Trópico de Cáncer', 'El Triunfo', 'El Malecón', 'Todos Santos'],
                'tags_en' => ['Balandra Beach', 'Tropic of Cancer', 'El Triunfo', 'The Malecón', 'Todos Santos']],
            ['name' => 'Recorrido Todos Santos', 'name_en' => 'Todos Santos Tour', 'duration' => '5 horas', 'price' => '$300 USD', 'price_suffix' => '',
                ...
                'description_en' => 'Round trip with panoramic views of the Pacific Ocean. Art galleries, the Jesuit Mission, Teatro del Pueblo, Hotel California and Cerritos Beach.',
                'tags' => ['Hotel California', 'Vista Pacífico', 'Misión Jesuita', 'Arte & Galerías', 'Cerritos'],
                'tags_en' => ['Hotel California', 'Pacific View', 'Jesuit Mission', 'Art & Galleries', 'Cerritos']],
        ];
    }
}
